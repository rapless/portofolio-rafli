    ...
    public function run(): void
    {
        ...
        $sections = [
            [
                ...
                'metadata' => ['profile_kicker' => 'Available for', 'profile_headline' => 'Web App · Laravel · UI Build', 'profile_description' => 'Ubah nama, deskripsi, foto profil, dan highlight ini langsung dari admin panel.'],
            ...
            [
                ...
                'eyebrow' => 'Kontak',
                'subtitle' => "Punya ide, project, atau kolaborasi? Kirim nama, email, dan pesan kamu lewat form di samping.",
                'content' => '<p>Semua pesan dari visitor akan otomatis tersimpan di admin panel bagian Contact Messages, jadi tidak ada pesan yang tercecer.</p>',
